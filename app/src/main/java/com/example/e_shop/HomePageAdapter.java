...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (homePageModelList.get(position).getType()){
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                ...
                ((HorizontalProductViewholder)viewHolder).setHorizontalProductLayout(horizontalProdutScrollModelList,horizontalLayoutTitle,layoutcolor,viewAllProductList);
                break;
            case HomePageModel.GRID_PRODUCT_VIEW:
                ...
                ((GridProductViewHolder)viewHolder).setGridProductLayout(gridlProdutScrollModelList,gridLayoutTitle,gridLayoutColor);
                break;
                default:
                    return;
        }
    ...
    public class StripAdBannerViewholder extends RecyclerView.ViewHolder{
        ...
        private void setStripAd(String resource,String color){
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.placeholder_banner)).into(stripAdImage);
    ...
    public class HorizontalProductViewholder extends RecyclerView.ViewHolder{
        ...
        private void setHorizontalProductLayout(List<HorizontalProdutScrollModel>horizontalProdutScrollModelList, final String title, String color, final List<WishlistModel> viewAllProductList){
        ...
        private void setGridProductLayout(final List<HorizontalProdutScrollModel> horizontalProdutScrollModelList, final String title, String color){
           container.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(color)));
            ...
            for (int x = 0; x < 4;x++){
                ...
                Glide.with(itemView).load(horizontalProdutScrollModelList.get(x).getProductImage()).apply(new RequestOptions().placeholder(R.drawable.placeholder_icon_1)).into(productImage);
                ...
                if (!title.equals("")) {
                    ...
                    gridProductLayout.getChildAt(x).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                           ...
                           productDetailsIntent.putExtra("PRODUCT_ID",horizontalProdutScrollModelList.get(finalX).getProductID());
