...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        switch (productSpecificationModelList.get(position).getType()){
            ...
            case 1:
                return ProductSpecificationModel.SPECIFICATION_BOBY;
                default:
                    return -1;
        }
    }
    ...
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        switch (viewType){
            case ProductSpecificationModel.SPECIFICATION_TITLE:
                ...
                case ProductSpecificationModel.SPECIFICATION_BOBY:
        ...
        switch (productSpecificationModelList.get(position).getType()){
            case ProductSpecificationModel.SPECIFICATION_TITLE:
                ...
                case ProductSpecificationModel.SPECIFICATION_BOBY:
                    ...
                    String featureDetail = productSpecificationModelList.get(position).getGetFeatureValue();
